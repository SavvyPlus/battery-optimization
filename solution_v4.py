    ...
    for index_simulation in range(start, end + 1):
        ...
        for i in range(1, len(datas)):
            ...
            if i == 1:
                ...
                dp[next][0] = max_profit(0, i, dp[current][0], -100000, dp[current][1] + sell, paths, current, next)
            ...
            if i == 2:
                ...
                dp[next][0] = max_profit(0, i, dp[current][0], -100000, dp[current][1] + sell, paths, current, next)
                dp[next][1] = max_profit(1, i, dp[current][1], dp[current][0] + buy, dp[current][2] + sell, paths,
                                         current, next)
            ...
            if i == 3:
                ...
                dp[next][1] = max_profit(1, i, dp[current][1], dp[current][0] + buy, dp[current][2] + sell, paths,
                                         current, next)
                dp[next][2] = max_profit(2, i, dp[current][2], dp[current][1] + buy, dp[current][3] + sell, paths,
                                         current, next)
            ...
            if i > 3:
                ...
                dp[next][2] = max_profit(2, i, dp[current][2], dp[current][1] + buy, dp[current][3] + sell, paths,
                                         current, next)
                dp[next][3] = max_profit(3, i, dp[current][3], dp[current][2] + buy, dp[current][4] + sell, paths,
                                         current, next)
...
print(length)
if rank == 0:
    file = open("Dispatches_1000_stimulation_v4", 'w')
